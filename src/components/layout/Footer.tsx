      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-200 mb-4">
              Rooted in Africa. Loved Worldwide. Premium organic skincare made from pure African ingredients.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>123 Main Street, Lagos, Nigeria</li>
              <li>+234 800 1234 567</li>
              <li>info@ayoglow.com</li>
            </ul>
          </div>

          {/* Newsletter */}
          <div>
            <h4 className="text-lg font-playfair font-bold mb-4">Subscribe</h4>
        ...
        <div className="border-t border-white/20 pt-6 mt-8">
          <p className="text-center text-sm text-gray-300">
            &copy; {new Date().getFullYear()} AyoGlow Naturals. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
