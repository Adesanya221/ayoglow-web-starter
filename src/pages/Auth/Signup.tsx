...
import { Eye, EyeOff, Mail, User, Key, AlertCircle } from "lucide-react";
...
const Signup = () => {
  ...
  const validatePassword = (password: string) => {
    return password.length >= 8; // Simple validation, can be expanded
  };
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("User registered:", { firstName, lastName, email, newsletterOptin });
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-md">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-primary font-playfair">Create Account</h2>
          <p className="mt-2 text-gray-600">
            Join AyoGlow and discover natural African skincare
          </p>
        </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 text-sm">
                <Label htmlFor="newsletter" className="text-gray-700">
                  Sign up for our newsletter to receive special offers and updates (optional)
                </Label>
              </div>
            </div>
          </div>
